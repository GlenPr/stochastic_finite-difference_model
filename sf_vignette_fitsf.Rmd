...
```{r}
y  = readRDS(sprintf("%s/data/test_y_array.rds",gOutputDir))
x  = readRDS(sprintf("%s/data/test_x_array.rds",gOutputDir))
#dt = readRDS(sprintf("%s/data/test_dt.csv",gOutputDir)) #we can load or make our own dt
